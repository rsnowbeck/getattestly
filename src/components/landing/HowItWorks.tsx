...
const steps = [
  {
    ...
    description: "Import employees, contractors, or vendors. Add names, emails, and optional details like department or role.",
    details: ["Bulk import via CSV", "Organize by groups", "No recipient limits on Pro plan"]
  },
  {
    number: "02",
    title: "Create a requirement",
    description: "Define what needs to be acknowledged. Upload a PDF, set a due date, and choose one-time or recurring.",
    details: ["Attach policy documents", "Set annual renewals", "Preview before publishing"]
  },
  {
    number: "03",
    title: "Publish & send",
