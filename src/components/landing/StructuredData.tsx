...
export function useOrganizationSchema() {
  useEffect(() => {
    ...
    const schema = {
      ...
      description: "Secure client portal for accounting and tax firms. Exchange documents, manage tasks, and communicate with clients securely.",
      foundingDate: "2025",
      contactPoint: {
        "@type": "ContactPoint",
...
export function useSoftwareApplicationSchema() {
  useEffect(() => {
    ...
    const schema = {
      ...
      operatingSystem: "Web",
      description: "Secure client portal for accounting and tax firms. Simplify document exchange, task management, and client communication.",
      offers: [
