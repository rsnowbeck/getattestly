  ...
  return <section className="section-hero pt-28 lg:pt-40 pb-20 lg:pb-32">
      <div className="container">
        <div className="mx-auto max-w-4xl text-center">
          ...
          {/* Headline */}
          <h1 className="text-3xl font-extrabold tracking-tight text-foreground sm:text-5xl lg:text-6xl mb-5 animate-slide-up">Compliance Acknowledgments<br /><span className="text-accent font-bold inline-block mt-2">Simplified</span></h1>
