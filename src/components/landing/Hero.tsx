  ...
  return <section className="section-hero py-20 lg:py-32">
      <div className="container">
        <div className="mx-auto max-w-4xl text-center">
          ...
          {/* Headline */}
          <h1 className="text-4xl font-extrabold tracking-tight text-foreground sm:text-5xl lg:text-6xl mb-6 animate-slide-up"><span className="whitespace-nowrap">Compliance Acknowledgments,</span><span className="block text-accent">Simplified</span></h1>

          {/* Subheadline */}
          <p className="mx-auto max-w-2xl text-lg text-muted-foreground mb-10 animate-slide-up" style={{
          animationDelay: "0.1s"
        }}>
